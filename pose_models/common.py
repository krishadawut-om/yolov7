...
from pose_utils.datasets import letterbox
from pose_utils.general import non_max_suppression, non_max_suppression_export, make_divisible, scale_coords, increment_path, xyxy2xywh, save_one_box
from pose_utils.plots import colors, plot_one_box
from pose_utils.torch_utils import time_synchronized
...
class SPP(nn.Module):
    ...
    def __init__(self, c1, c2, k=(3, 3, 3)):
        ...
        for pool_kernel in k:
            ...
            max_pool_module_list.append(nn.Sequential(
                *num_3x3_maxpool*[nn.MaxPool2d(kernel_size=3, stride=1, padding=1)]))
